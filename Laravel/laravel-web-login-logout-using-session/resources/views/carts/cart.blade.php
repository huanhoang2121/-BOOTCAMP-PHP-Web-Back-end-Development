            ...
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    ...
                    <td class="actions" data-th="">
                        <button class="btn btn-info btn-sm update-cart"><a href="{{ route('update-cart', $id)  }}"><i class="fa fa-refresh">Update</i></a></button>
                        <button class="btn btn-danger btn-sm remove-from-cart"><a href="{{ route('remove-from-cart', $id)  }}"><i class="fa fa-trash-o">Delete</i></a></button>
                    </td>
                </tr>
            @endforeach
        @endif
