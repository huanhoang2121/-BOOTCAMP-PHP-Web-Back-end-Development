        ...
        <div class="container">
            <div class="welcome-top heading">
                ...
                <div class="welcome-bottom">
                    <img src="{{asset('storage/images/abt-1.jpg')}}" alt=""/>
        ...
        <div class="container">
            ...
            <div class="team-bottom">
                <div class="col-md-3 team-left">
                    <img src="{{asset('storage/images/t-1.jpg')}}" alt="" />
                    <h4>Rita Nelson</h4>
                    <p>Fusce at elementum diam. Integer pellentesque ultricies pharetra.</p>
                </div>
                <div class="col-md-3 team-left">
                    <img src="{{asset('storage/images/t-2.jpg')}}" alt="" />
                    <h4>Marta Healy</h4>
                    <p>Fusce at elementum diam. Integer pellentesque ultricies pharetra.</p>
                </div>
                <div class="col-md-3 team-left">
                    <img src="{{asset('storage/images/t-3.jpg')}}" alt="" />
                    <h4>John Black</h4>
                    <p>Fusce at elementum diam. Integer pellentesque ultricies pharetra.</p>
                </div>
                <div class="col-md-3 team-left">
                    <img src="{{asset('storage/images/t-4.jpg')}}" alt="" />
                    <h4>Kate Tompson</h4>
                    <p>Fusce at elementum diam. Integer pellentesque ultricies pharetra.</p>
                </div>
